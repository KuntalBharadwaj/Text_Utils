...
function About(props) {
    ...
    let aboutStyle = {
        color: props.mode==='dark'?'white':'#03032f',
        backgroundColor: props.mode==='dark'?'#03032f': 'white'
    }
            ...
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button" style={aboutStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            Accordion Item #1
                        </button>
                    </h2>
